...
!!! note
    ...
    * Learn more about [animations](/popochiu/how-to-develop-a-game/playing-animations).
...
We are now going to script our first interaction, using Godot **GDScript** language and the very convenient [engine API](/popochiu/the-engine-handbook/scriting-overview) that Popochiu provides to make our life easier.
