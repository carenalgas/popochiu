...
* This tutorial overlooks many important parts, among which [animations](/popochiu/how-to-develop-a-game/playing-animations) and [audio management](/popochiu/how-to-develop-a-game/adding-sounds) certainly stand out. The [How to Develop a Game](/how-to-develop-a-game) section contains basics and advanced techniques that will help you get the most out of Godot and Popochiu.
