...
const SCRIPT_TEMPLATE := 'res://addons/popochiu/engine/templates/hotspot_template.gd'
const HOTSPOT_SCENE := 'res://addons/popochiu/engine/objects/hotspot/popochiu_hotspot.tscn'
